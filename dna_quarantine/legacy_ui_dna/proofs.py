...
RINPA_DECORATIVE_SPATIAL_DNA = DesignDNA(
    ...
    # S8.2 Deepened Production Profile
    visual_energy="expressive",
    spatial_density="spacious",
    composition_balance="asymmetric",
    hierarchy_strength="strong",
    surface_character="layered",
    shape_character="organic",
    ornament_emphasis="selective",
    interaction_intensity="deliberate",
...
# DNA B — Japan Print / Ink (Identity DNA)
JAPAN_PRINT_INK_DNA = DesignDNA(
    ...
    composition_balance="regular",
    hierarchy_strength="strong",
    surface_character="paper",
    shape_character="restrained",
    ornament_emphasis="subtle",
    interaction_intensity="deliberate",
    responsive_identity_priority="preserve_core",
    materials=[
        MaterialReference(
            id="japan-ink-mark",
            material_type="graphic_mark",
...
# DNA C — Chainsaw Man-Inspired (Identity DNA)
...
# DNA D — Mushishi-Inspired (Identity DNA)
MUSHISHI_INSPIRED_DNA = DesignDNA(
    ...
    visual_energy="quiet",
    spatial_density="spacious",
    composition_balance="organic",
    hierarchy_strength="soft",
    surface_character="atmospheric",
    shape_character="organic",
    ornament_emphasis="subtle",
