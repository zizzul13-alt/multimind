...
# LOCKED_RECOVERED is used only where the mechanism/fingerprint is directly
# recoverable from surviving Wave-E/B7/Batch-4 evidence. Title-level EQ3 alone
# is not enough to earn this label. CONSERVATIVE_TRANSLATION means the runtime
# fingerprint is a bounded implementation translation over locked P01-P25 and
# is never represented as verbatim historical recovery.
_PROFILE: Mapping[str, Tuple[str, Axis, Tuple[str, ...], str]] = {
    ...
    "IZM06": ("ORNAMENT_CONSTRUCTION_REVEAL", Axis.FORM, ("P11", "P12"), "CONSERVATIVE_TRANSLATION"),
    ...
    "IZW03": ("SYSTEM_WORLD_DUAL_LAYER_STATE_OVERLAY", Axis.INFORMATION, ("P05", "P07", "P17"), "CONSERVATIVE_TRANSLATION"),
    "IZW04": ("SCALE_PUNCTUATED_PROGRESSIVE_SYSTEM_REVEAL", Axis.SCALE_GRANULARITY, ("P01", "P04", "P05"), "CONSERVATIVE_TRANSLATION"),
