...
IZZUL_PRIMITIVE_NAMES: Dict[str, str] = {
    "P01": "SCALE_PUNCTUATION",
    "P02": "NEGATIVE_SPACE_PACING",
    "P03": "DENSITY_MODULATION",
    "P04": "PROGRESSIVE_REVEAL",
    "P05": "STATE_OVERLAY",
    "P06": "TOPOLOGICAL_TRAVERSAL",
    "P07": "LAYERED_WORLD_RULES",
    "P08": "TEMPORAL_PUNCTUATION",
    "P09": "STATE_LINKED_DEFORMATION",
    "P10": "DIRECTIONAL_FORCE_FORM",
    "P11": "ORNAMENT_AS_STRUCTURE",
    "P12": "MATERIAL_LAYER_REVEAL",
    "P13": "EDITORIAL_SEGMENT_PUNCTUATION",
    "P14": "RELATIONAL_ANCHOR",
    "P15": "REPRESENTATIONAL_MISMATCH",
    "P16": "ENVIRONMENTAL_CAUSALITY",
    "P17": "SYSTEM_WORLD_DUAL_LAYER",
    "P18": "DETAIL_DENSITY_FOCUS",
    "P19": "CROPPING_AS_COMPOSITION",
    "P20": "REFRACTIVE_FRAGMENTATION",
    "P21": "CONFRONTATION_TIME_DILATION",
    "P22": "RULE_CHANGING_STAGE",
    "P23": "INFRASTRUCTURE_AS_SYSTEM",
    "P24": "CORRESPONDENCE_AS_OBJECT",
    "P25": "RHYTHMIC_CULTURAL_SPLICE",
}

MIKO_PRIMITIVE_NAMES: Dict[str, str] = {
    "MK01": "TRAJECTORY_INTERVENTION",
    "MK02": "PERIPHERAL_AGENCY",
    "MK03": "ROLE_REFRAMING",
    "MK04": "POST_CANON_REPAIR",
    "MK05": "CARE_ACCUMULATION",
    "MK06": "CAPABILITY_TRANSFER",
    "MK07": "PREVENTIVE_GUIDANCE",
    "MK08": "CHOSEN_KINSHIP",
    "MK09": "CONTESTED_BELONGING",
    "MK10": "LATENT_CAPABILITY",
    "MK11": "CARE_FIRST_HIERARCHY",
    "MK12": "LOW_PROFILE_SURVIVAL",
    "MK13": "RESOURCE_CONSTRAINED_PLANNING",
    "MK14": "TIMELINE_DRIFT",
    "MK15": "ENDING_AUTHORITY",
    "MK16": "EXIT_STRATEGY_SET",
    "MK17": "RELATIONAL_PERSISTENCE",
    "MK18": "FUTURE_JUDGMENT_FEEDBACK",
    "MK19": "SOCIAL_PERCEPTION_GAP",
    "MK20": "VOLUNTARY_ROLE_EXPANSION",
    "MK21": "SIBLING_GUARDIANSHIP",
    "MK22": "PATRONAGE_INDIRECT_AGENCY",
    "MK23": "UNCERTAINTY_INTERPRETATION",
    "MK24": "BOUNDARY_SETTING_IN_CARE",
    "MK25": "SYSTEM_LITERACY_FROM_LOW_STATUS",
}

TEMPORAL_PRIMITIVE_NAMES: Dict[str, str] = {
    "TP01": "PERIODICITY",
    "TP02": "STRUCTURAL_BOUNDARY",
    "TP03": "INTENSITY_ENVELOPE",
    "TP04": "RESOLUTION",
    "TP05": "RECURRENCE_WITH_VARIATION",
    "TP06": "RETURN_RECALL",
    "TP07": "CALL_RESPONSE_HANDOFF",
    "TP08": "EXPECTATION_DISPLACEMENT",
    "TP09": "INTERRUPTION",
    "TP10": "NEGATIVE_INTERVAL_RESERVED_GAP",
    "TP11": "RATE_CHANGE",
    "TP12": "DENSITY_EVOLUTION",
    "TP13": "LAYER_ENTRY_EXIT",
    "TP14": "PARALLEL_TEMPORAL_VOICES",
    "TP15": "ANTICIPATION",
    "TP16": "IRREVERSIBLE_PROGRESSION",
    "TP17": "TERMINAL_RESOLUTION_AFTERBODY",
    "TP18": "TEMPORAL_PUNCTUATION",
}
...
_P_AXIS: Dict[str, Axis] = {
    "P01": Axis.SCALE_GRANULARITY,
    "P02": Axis.SPACE,
    "P03": Axis.INFORMATION,
    "P04": Axis.NARRATIVE_SEQUENCING,
    "P05": Axis.INFORMATION,
    "P06": Axis.NARRATIVE_SEQUENCING,
    "P07": Axis.INFORMATION,
    "P08": Axis.MOTION_TEMPORAL,
    "P09": Axis.FORM,
    "P10": Axis.FORM,
    "P11": Axis.FORM,
    "P12": Axis.MATERIAL_CONSTRUCTION,
    "P13": Axis.NARRATIVE_SEQUENCING,
    "P14": Axis.INFORMATION,
    "P15": Axis.FORM,
    "P16": Axis.ATMOSPHERE_ENVIRONMENT,
    "P17": Axis.INFORMATION,
    "P18": Axis.INFORMATION,
    "P19": Axis.SPACE,
    "P20": Axis.FORM,
    "P21": Axis.MOTION_TEMPORAL,
    "P22": Axis.INTERACTION,
    "P23": Axis.INFORMATION,
    "P24": Axis.INFORMATION,
    "P25": Axis.NARRATIVE_SEQUENCING,
}

_MK_AXIS: Dict[str, Axis] = {
    "MK01": Axis.NARRATIVE_SEQUENCING,
    "MK02": Axis.INFORMATION,
    "MK03": Axis.INFORMATION,
    "MK04": Axis.NARRATIVE_SEQUENCING,
    "MK05": Axis.INFORMATION,
    "MK06": Axis.NARRATIVE_SEQUENCING,
    "MK07": Axis.INFORMATION,
    "MK08": Axis.INFORMATION,
    "MK09": Axis.INFORMATION,
    "MK10": Axis.INFORMATION,
    "MK11": Axis.INFORMATION,
    "MK12": Axis.NARRATIVE_SEQUENCING,
    "MK13": Axis.INFORMATION,
    "MK14": Axis.NARRATIVE_SEQUENCING,
    "MK15": Axis.NARRATIVE_SEQUENCING,
    "MK16": Axis.INFORMATION,
    "MK17": Axis.INFORMATION,
    "MK18": Axis.INFORMATION,
    "MK19": Axis.INFORMATION,
    "MK20": Axis.NARRATIVE_SEQUENCING,
    "MK21": Axis.INFORMATION,
    "MK22": Axis.INFORMATION,
    "MK23": Axis.INFORMATION,
    "MK24": Axis.INTERACTION,
    "MK25": Axis.INFORMATION,
}
...
def _zones(axis: Axis):
    ...
    if axis is Axis.FORM or axis is Axis.SPACE or axis is Axis.MATERIAL_CONSTRUCTION or axis is Axis.ATMOSPHERE_ENVIRONMENT:
...
def _izzul_directive(primitive_id: str, name: str) -> str:
    ...
    if primitive_id == "P16":
        base += ";environmental-causality-must-come-from-existing-context-and-never-live-or-invented-environment-state"
    if primitive_id == "P22":
        base += ";rule-change-cues-may-reflect-only-an-existing-application-state-transition-and-never-create-rules-actions-or-permissions"
    if primitive_id == "P25":
        base += ";rhythmic-cultural-splice-never-asserts-a-cultural-lineage-without-a-separately-governed-reference"
    return base
