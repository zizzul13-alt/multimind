...
TRACK_M_R_SELECTOR_POLICY_BY_ID: Mapping[str, str] = {
    ...
    "MR-014": "ONE_SUPPORTED_KUBA_BRANCH_AT_A_TIME__FIXED_MULTI_PANEL_STITCHED_APPLIQUE_WRAPPER__NO_CROSS_VARIANT_SYNTHESIS",
    ...
    "MR-021": "ONE_SUPPORTED_CONSERVATION_OPERATION_AT_A_TIME__FIXED_STRUCTURAL_WOODWORK_CONSERVATION_OPERATION__NO_UNIVERSAL_JAPANESE_JOINT",
...
TRACK_M_R_CONSTRUCTION_BY_ID: Mapping[str, str] = {
    ...
    "MR-004": "true-mechanical-inlay-process-uses-a-harder-metal-host-with-a-prepared-recess-or-zone-then-softer-contrasting-metal-is-mechanically-seated-or-hammered-and-finished-flush-or-burnished-painted-or-surface-overlay-lines-do-not-qualify",
    ...
    "MR-014": "fixed-project-scope-selects-the-evidence-supported-multi-panel-stitched-or-appliqued-wrapper-layered-construction-branch-and-forbids-blending-single-panel-cut-pile-or-embroidery-branches-into-one-fictional-mechanism",
    ...
    "MR-017": "ordered-warp-setup-loom-weave-process-and-design-forming-weft-or-warp-operations-create-the-structural-field-without-treating-yakan-motif-semantics-as-construction-evidence",
    ...
    "MR-021": "fixed-project-scope-selects-the-supported-structural-woodwork-conservation-process-operation-and-preserves-substrate-tool-operation-and-sequence-without-synthesizing-the-unesco-skill-set-into-a-universal-japanese-joint-or-importing-roofing-thatching-plastering-lacquer-painting-tatami-or-other-inventory-skill-behavior",
