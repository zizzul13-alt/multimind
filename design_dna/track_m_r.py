...
TRACK_M_R_CONSTRUCTION_BY_ID: Mapping[str, str] = {
    ...
    "MR-014": "fixed-project-scope-selects-the-evidence-supported-multi-panel-stitched-or-appliqued-wrapper-branch-and-forbids-blending-single-panel-cut-pile-or-embroidery-branches-into-one-fictional-mechanism",
    ...
    "MR-021": "fixed-project-scope-selects-the-supported-structural-woodwork-conservation-operation-and-preserves-substrate-tool-operation-and-sequence-without-synthesizing-the-unesco-skill-set-into-a-universal-japanese-joint-or-importing-roofing-thatching-plastering-lacquer-painting-tatami-or-other-inventory-skill-behavior",
