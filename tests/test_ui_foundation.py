...
class TestUIFoundation(unittest.TestCase):
    ...
    def test_restore_state_invalidation_keeps_authenticated_identity(self):
        from core.application import ApplicationRuntime
        ...
        runtime.invalidate_database_derived_state()

        self.assertIsNone(runtime.current_session)
        self.assertEqual(runtime.memories, {})
